...
describe("GET /companies", function () {
  ...
  test("return empty array for companies if no matching results",
    async function () {
      const resp = await request(app).get("/companies?nameLike=scooby%20%doo");
...
describe("PATCH /companies/:handle", function () {
  ...
  test("non-admins cannot update", async function () {
    const resp = await request(app)
      .patch(`/companies/c1`)
      .send({
        name: "C1-new",
...
describe("DELETE /companies/:handle", function () {
  ...
  test("non-admins cannot delete", async function () {
    const resp = await request(app)
      .delete(`/companies/c1`)
      .set("authorization", `Bearer ${u1Token}`);
    expect(resp.body).toEqual({
